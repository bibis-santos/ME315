...
#ra: 185276 - Fernanda da Silva Cardozo 
#ra: 236056 - Bianca da Silva dos Santos
```{r}
library(tidyverse)
library(dplyr)
library(ggplot2)
...
```{r}
#lendo os arquivos 
arquivo <- read_csv("//smb/ra236056/Downloads/lab2_25/dadosflights/flights.csv")
airports <- read_csv("//smb/ra236056/Downloads/lab2_25/dadosflights/airports.csv")

```


```{r}
# - tail_number: código identificador da aeronave (ex: "M431WN")
# - arquivo: caminho completo para o arquivo flights.csv.zip
# - arquivo_airports: caminho para o arquivo airports.csv

# função callback que filtra apenas a aeronave desejada

analisa_aeronave <- function(tail_number, arquivo , airports = airports) {
...
dados_aeronave <- read_csv_chunked(
  ...
  cat("Ordenando dados por data e hora...\n")
  ...
  dados_ordenados <- dados_aeronave %>%
    mutate(
      ...
      # Criar datetime de partida (formato simplificado)
  ...
  cat("Preparando dados para o mapa...\n")
